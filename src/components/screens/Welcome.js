...
export default function welcome() {
  return (
    <div className="bg-lite" style={{ height: "300vh" }}>
      ...
      <span className="text-danger"> Note that there is currently no backend so nothing will save when you reload the page!</span>
      </Card.Text>
      <Card.Footer>
        The react app is being maintained at <a href="https://github.com/levmckinney/yoloxide-web.git"> yoloxide-sweb </a>.
      </Card.Footer>
      <Card.Footer>
